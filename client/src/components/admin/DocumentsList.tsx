...
export function DocumentsList() {
    ...
    const fetchDocuments = async () => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/documents`, {
                headers: {
    ...
    const handleDownload = async (doc: Document) => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/documents/${documentId}/download`, {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('sessionId')}`
                }
            });
    ...
    const handleDelete = async (doc: Document) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/admin/documents/${documentId}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('sessionId')}`
                }
